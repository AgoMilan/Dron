# -*- coding: utf-8 -*-
"""
Created on Thu Oct  2 00:24:26 2025
...
# -*- coding: utf-8 -*-
"""
Rozšířený skript pro sledování dronu s predikcí při zastínění
...
def main(args):
    ...
    while True:
        ...
        # vykreslení YOLO boxů (jen informativně)
        ...
        # vykreslení vybraného dronu (červeně / modře)
        if vis is not None and tracks and selected_id is not None:
            for t in tracks:
                ...
                if t.is_confirmed() and t.time_since_update == 0:
                    color = (0, 0, 255)   # červená – detekce
                    state = "detekce"
                else:
                    color = (255, 0, 0)   # modrá – predikce
                    state = "predikce"
