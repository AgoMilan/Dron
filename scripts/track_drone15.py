# -*- coding: utf-8 -*-
"""
Created on Wed Oct  1 22:05:33 2025
...
def main(args):
    ...
    # DeepSORT tracker s laditelnými parametry
    tracker = DeepSort(
        max_age=args.max_age,              # ❗ kolik snímků může být objekt nezachycen, než se track ukončí
        n_init=args.n_init,                # ❗ kolik detekcí je potřeba k potvrzení nového tracku
        max_iou_distance=args.iou_dist     # ❗ maximální vzdálenost (IoU) pro přiřazení tracku k nové detekci
    )
    ...
    while True:
        ...
        # vykreslení vybraného dronu (červeně)
        ...
        # debug – červený křížek v místě kliknutí
