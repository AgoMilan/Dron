# -*- coding: utf-8 -*-
"""
Created on Sun Oct 12 10:26:29 2025

@author: Milan

yolo_deepsort_eos77_5.py
---------------------------------
Live stream z Canon EOS 77D (USB / index 0)
YOLOv8 + DeepSORT
Oprava posunu rámečku (koordináty mapované do původní velikosti)
nejlepší výsledek spoštěcí příkaz:   python .\yolo_deepsort_eos77_5.py --source 0 --display --winsize 900 --shrink 0.3
"""
